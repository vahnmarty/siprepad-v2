<x-auth-layout>
    ...
    <div class="mx-auto bg-white rounded-md lg:max-w-4xl">
        <div class="grid gap-8 shadow-lg lg:grid-cols-2">
            ...
            <div class="flex flex-col justify-center bg-red-100 border-left lg:px-8 lg:py-16 rounded-r-md">
                <a href="/">
                ...
                <p class="mt-8">Already a User? <a href="{{ route('login') }}" class="font-bold text-red-700 underline">Log In</a></p>
            </div>

            <div class="lg:px-8 lg:py-32 rounded-l-md">
